<?php          
        ...
        <div class="row sea-box">
          <a href="<?php echo base_url('trip/tripdetails/'.$search_result['trip_led_id']);?>">
            ...
            <div class="sea-col2">
             <h3><?=date('Y/m/d l ',  strtotime(str_replace('/', '-', $selparam['date'])));?> <?=($search_result['expected_time']!=''?'- '.$search_result['expected_time']:$search_result['trip_depature_time']);?></h3>
              <div class="line2"></div>
            ...
            <div class="sea-col3">
              ...
              <?php
                    if($search_result['trip_casual_date']){
                       echo getAvailableSeat(date('Y-m-d',  strtotime(str_replace('/', '-', $search_result['trip_casual_date']))),$search_result['trip_id']);
                    }else{
              ...
              <span class="size14"> <?php echo lang('available_seat');?> </span>
              <br><br>
