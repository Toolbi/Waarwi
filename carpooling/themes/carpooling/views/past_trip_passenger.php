...
<div class="inner-red"> 
 <div class="tab-container">   
    ...
    <a href="<?= base_url('addtrip/upcoming_trip_passenger') ?>" class="btn btn-tab"><?php echo lang('upcoming_trips'); ?> </a>
    <a href="javascript:void(0)" class="btn btn-tab active"><?php echo lang('past_trips'); ?></a>
    </div>
