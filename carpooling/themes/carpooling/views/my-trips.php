...
<div class="inner-red">
  	<div class="fleft width100 margin">
	    ...
	    <div class="p_top">
	    	<!-- trajets proposés -->
		    <a id="a_tab" class="b_t_1" onclick="tab_tab(this, 'p_block_bottom'), 
		     height_right()"><?php echo lang('rides_offered');?></a>
		     <!-- demandes -->
		    <a id="a_tab" class="b_t_1 enquery" href="<?=base_url('addtrip/upcoming_trip_passenger')?>" >
		     <?php echo lang('enquiry');?></a>
		    <div class="cr"></div>
	  	</div>      
    	<div class="obj_cont p_block_bottom rowrec" style="display: block;">
        	<div class="my-trp-tab row">
	          	<div class="my-trp-main">
		            ...
		            <a href="<?=base_url('addtrip/past_trip')?>" class="trp-main-active"><?php echo lang('past_trips');?></a>
	          	</div>
          		<div class="my-trp-content rowrec" id="pageresult">
	            	...
	            	<div class="inner-trip-det">
              			...
              			<div id="slide<?=$i?>" style="display:none">
		              		...
		              		<h5 class="fleft width100 inner-in-trp"> <img src="<?php echo theme_img('trip-icon.png') ?>"> 
		              		<?php echo lang('trip_leg');?>:</h5>
		               		<?php  
