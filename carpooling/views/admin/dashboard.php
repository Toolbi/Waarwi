								...
								<div class="col-md-12">
									<div class="main-box">
										<header class="main-box-header clearfix">
											<h2 class="pull-left"><?php echo lang('total_daily_users');?></h2>
										</header>
                            ...
                            <div class="row">
								...
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="main-box infographic-box">
										...
										<span class="headline"><?php echo lang('testimonials');?></span>
										<span class="value">
								...
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="main-box infographic-box">
										...
										<span class="headline"><?php echo lang('vehicle_brand');?></span>
										<span class="value">
	...
	$(document).ready(function() {
		...
		if ($('#graph-bar').length) {
			...
			series.push({
				...
				label: "<?php echo lang('daily_users');?>"
			});
