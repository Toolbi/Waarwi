     ...
     <a href="<?php echo base_url('home');?>"id="logo" class="navbar-brand"><img src="<?php echo theme_logo_img($this->logo->name)?>"style="width:115px;"> </a> </div>
        ...
        ?>  
            <ul class="top-nav new-top-nav pull-right">
              <li>  <a href="<?php echo base_url('addtrip/step_1');?>" class="ride btn defaut-bouton"><?php echo lang('post_a_trip');?></a> </li>
              <li>
                <div id="my-account">
            ...
            <li><a href="<?php echo base_url('addtrip/enquery_list');?>"> <img src="<?php echo theme_img('star-ico.png')?>" width="13"> <?php echo lang('my_enquiries_message'); ?> </a></li>
              ...
              <?php else: ?>
                ...
                <li> <a href="<?php echo base_url('login');?>" class="btn ride top-signup"><i class="fa fa-user"></i> <?php echo lang('login');?> </a> </li>
