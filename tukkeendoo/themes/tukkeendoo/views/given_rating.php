...
<div class="container-fluid margintop40">
  ...
  <div class="trips"> 
        <ul class="brd-crmb">
          ...
          <li> / </li>
          <li><?php echo lang('received_ratings');?></li>
         
        </ul>
             
         <div class="active-yellow padding10">
        <h4> <?php echo lang('my_rating');?>: <?php echo lang('rating_given');?></h4>
            ...
            <div class="inner-yellow">
                <div class="obj_cont p_block_bottom rowrec" style="display: block;">
                    ...
                    <a id="a_tab" class="btn btn-tab-y" href="<?php echo base_url('rating/received_rating');?>"><?php echo  lang('received_ratings'); ?></a>
                    <a id="a_tab" class="btn btn-tab-y active"><?php echo lang('rating_given'); ?></a>	
                     <?php if ($given_rating) { ?>  
                      <span class="description-text"> <?php echo lang('given_rating_desc'); ?></span>
                     <?php }else{ } ?>
                    <div class="cr">
                    </div>
