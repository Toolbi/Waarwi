...
$(document).ready(function() {
	...
	$("#frmtrip").validate({
			...
			messages: {
				...
				vechicletype: {
					required: "<?php echo lang('vechicletype');?>",
				},
				...
				'amenities[]': {
					required: "<?php echo lang('amenities');?>",
				},
				txtsource: {
					required: "<?php echo lang('txtsource');?>",
				},
				txtdestination: {
					required: "<?php echo lang('txtdestination');?>",
				},
				avail_seats: {
					required: "<?php echo lang('avail_seats');?>",
				},
				jhour: {
					required: "<?php echo lang('jhour');?>",
				},
				passenger_type: {
					required: "<?php echo lang('passenger_type');?>",
				},
				name: {
					required: "<?php echo lang('name_error');?>",
				},
				number: {
					required: "<?php echo lang('number_error');?>",
					
				},
				comments: {
					required: "<?php echo lang('comments_error');?>",
				},
				jquerytagboxtext:{
					required: "<?php echo lang('jquerytagboxtext');?>",
				},
				tzone:{
					required: "<?php echo lang('tzone');?>",
				},
				frequency:{
					required: "<?php echo lang('frequency_error');?>",
				},
