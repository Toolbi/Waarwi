    ...
    <div class="container">
        <div class="row">
            <ul class="brd-crmb">
                ...
                <li> / </li>
                <li><a href="#"><?php echo lang('my_rating');?></a></li>
            </ul>
            <div class="container-fluid">
                <div class="container">
                    <div class="fleft width100 margin">

                        <h2 class="pst-trip-tit"><?php echo lang('my_rating'); ?></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="fleft width100 margin">
                <div class="p_top">
                    <a id="a_tab" class="b_t_1  active" onclick="tab_tab(this, 'p_block_bottom'), height_right()"><?php echo lang('ratings_pending'); ?></a>      
                    <a id="a_tab" class="b_t_1 enquery" href="<?php echo base_url('rating/received_rating');?>"><?php echo  lang('received_ratings'); ?></a>
                    <a id="a_tab" class="b_t_1 enquery" href="<?php echo base_url('rating/given_rating');?>"><?php echo lang('rating_given'); ?></a>	
                    <div class="cr">
                    </div>
                </div>
